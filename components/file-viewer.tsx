...
import { Download, ExternalLink, FileText, FileArchive, Eye, Maximize2 } from 'lucide-react';
        ...
        <div className="flex items-center space-x-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">
              {isPdf ? 'Định dạng PDF (Xem trực tiếp bên dưới)' : 'Tập tin nén / Tài liệu văn bản'}
            </p>
          </div>
        </div>
